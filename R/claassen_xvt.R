#' Cross-validation testing for Claassen's (2019) Model 5 
#'
#' \code{claassen_xvt} performs a single cross-validation test for Claassen's (2019) Model 5 estimates of cross-national public opinion
#'

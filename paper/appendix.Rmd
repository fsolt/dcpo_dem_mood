...
# Table A1. Estimates of Democratic Support on Democratic Institutions{#AJPSreplication}
...
df_tableAJPS %>% 
  ...
  add_header_lines(values = "Estimates of Democratic Support on Democratic Institutions") %>% 
  autofit() %>% 
  fit_to_width(8.5)

```

# Table A2. Estimates of Democratic Institutions on Democratic Support{#APSRreplication}
...
df_tableAPSR %>% 
  ...
  add_header_lines(values = "Estimates of Democratic Institutions on Democratic Support") %>% 
  autofit() %>% 
  fit_to_width(8.5)

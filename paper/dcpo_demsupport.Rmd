...
For additional detail on this technique, see the Supplementary Materials.
...
```{r plot-mainAJPS, fig.cap= "The Effect of Public Support on Democracy with Uncertainty", fig.width=5, fig.height=10, fig.align='center'}
...
df_plot <- bind_rows(result_pooledAJPS, result_regimeAJPS) %>% 
    mutate(term = case_when(term0 == 'Democracy\n (t-1)' ~ "Democracy[t-1]",
           ...
           term = factor(term, levels =  c(
               ...
               "Democratic~Support[t-1]~(democracies)",
               "Democratic~Support[t-1]~(autocracies)",

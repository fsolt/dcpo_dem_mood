...
small_multiple(df_plot, dot_args = list(size = .9, fatten = 1)) +
  ...
  ggtitle("DV: V-Dem Liberal Democracy Index")
...
```{r plot-mainAPSR, fig.cap= "The Effect of Democracy on Change in Public Support with Uncertainty", fig.width=7, fig.height=10}
...
small_multiple(df_plot, dot_args = list(size = .9, fatten = 1)) +
    ...
    ggtitle("DV: Change in Public Support for Democracy")

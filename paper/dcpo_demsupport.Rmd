...
load(here("output", "estimates_clsMeanAPSR.RDS"))
...
```{r visualizeFullUncertainAJPS, fig.cap= "The Effect of Public Support on Democracy", eval = TRUE, fig.width=7.5, fig.height=10}
...
saveRDS(result_clsFullUncertainAPSR, file = here::here("output", "estimates_clsAPSR.RDS"))
...
```{r visualizedAPSR, fig.cap= "The Effect of Democracy on Public Support", eval = FALSE, fig.width=7, fig.height=10}
...
result_clsFullUncertainAPSR <- readRDS(here("output", "estimates_clsAPSRfullUncertain.RDS"))
result_dcpoFullUncertainAPSR <- readRDS(here("output", "estimates_dcpoAPSRfullUncertain.RDS"))

...
We conduct inferences from the distributive data via a technique known as "method of composition" (MOC) [@Tanner1993, p.52;@Treier2008, p. 215; @caughey2018,p.A15-16].
...
Since measurement uncertainty associated with these latent variables can propogate into the inferences over coefficient parameters in models, we incorporate uncertainty by employing "Method of Composition" [@Tanner1993,p52], which has been applied in analyses with latent variables [@Treier2008;@caughey2018;@Kastellec2015].

...
```{r cls-AJPSpure}
result_AJPSpure <- map(ls_mod_ajpsCLS, function(aMod){ # reading a model
...
names(result_AJPSpure) <- c("pooled", "pooled-regime", "gmm", "gmm-regime")
   
saveRDS(result_AJPSpure, file = here::here("output", "estimates_clsAJPSpure.RDS"))
```
...
result_AJPSpure <- readRDS(here("output", "estimates_clsAJPSfullUncertain.RDS"))
...
result_pooled <- bind_rows(
  mutate(result_cls$pooled[[1]], model = "Claassen 2020a"),
  mutate(result_AJPSpure$pooled[[1]], model = "Claassen w/ Uncertainty"),
...
result_gmm <- bind_rows(
  mutate(result_cls$gmm[[1]], model = "Claassen 2020a"),
  mutate(result_AJPSpure$gmm[[1]], model = "Claassen w/ Uncertainty"),
...
result_regime <- bind_rows(
  mutate(result_cls$`pooled-regime`[[1]], model = "Claassen 2020a"),
  mutate(result_AJPSpure$`pooled-regime`[[1]], model = "Claassen w/ Uncertainty"),
...
result_regimeGmm <- bind_rows(
  mutate(result_cls$`gmm-regime`[[1]], model = "Claassen 2020a"),
  mutate(result_AJPSpure$`gmm-regime`[[1]], model = "Claassen w/ Uncertainty"),

...
In the step 3, the marginal distribution of a parameter vector $\beta$ was estimated, intergrating over $p(\theta|Z)$:
...
We incorporate uncertainty for five variables, public support for democracy, liberal democracy, electoral democracy, the liberal component index, and the corruption perceptions index.

...
# Supplementary Appendix A: Replication Notes {#dgp}

Replicating the analyses of @Claassen2020a and @Claassen2020b while incorporating the quantified uncertainty in their variables was not possible from those article's Dataverse files.
...
First, we identified the variable names of each survey item in each survey dataset as well as their corresponding values. 
We then used the `DCPOtools` R package to automate the process of generating a dataset of survey marginals.
Due to revisions to the underlying datasets (and, possibly, transcription errors), we were not able to locate 5 country-year-items: including South Sudan in Arab Barometer Wave 4, Dominican Republic in 2003 Latinobarometer, XXXX, and Spain in 2005 Latinobarometer. 

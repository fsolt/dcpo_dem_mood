...
## Replication data
load(here("data", "dcpo_ajps.rda"))  # https://osf.io/xxxx/download
load(here("data", "dcpo_apsr.rda"))  # https://osf.io/xxxx/download
load(here("data", "dcpo_input_update22.rda"))  # https://osf.io/xxxx/download

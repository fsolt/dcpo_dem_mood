...
Note that, for the GMM models, the original publication presented the observation number based on the trimmed data, i.e., "2435", while the tabulating function in the replication file (line 86) uses the full used-observation number, "4735." 

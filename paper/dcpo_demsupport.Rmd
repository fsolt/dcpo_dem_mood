...
In the OLS models, the public support from originial data with uncertainty is significant for both pooled data and split data for democracies but the support estimated from the expanded data is not.
In GMM models which should yield more accurate results than OLS models, the coeffient of public support is not significant for pooled data but significant for split sample data with original data. 
...
```{r plot-mocAPSR, fig.cap= "The Effect of Democracy on the Change of Public Support", eval = TRUE, fig.width=7, fig.height=10}

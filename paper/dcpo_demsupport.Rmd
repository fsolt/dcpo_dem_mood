...
One classic but unresolved question in comparative politics is the relationships between mass democratic support and countries' levels of democracy.
A long-standing and widely accepted theory is that the extent of mass democratic support determines the stability of a democratic system [e.g., @lipset_social_1959; @easton1965systems; @norris_democratic_2011], but empirical findings remain inconclusive [@inglehart_modernization_2005; @fails_changing_2010; @qi_how_2011; for a review of this literature, see @Claassen2020a].

One important reason for these mixed results is the difficulty in measuring comparative public democratic support.
Public support for democracy cannot be directly observed, and its incorrect measurement will limit inferences about the relationship between public opinion and democratic institutional development.
However, the survey data available across countries and over time on support for democracy--or indeed nearly any topic in public opinion---are sparse and incomparable, greatly hindering the broadly comparative research needed to reach sound conclusions.
Recently, a few pioneering studies have sought to overcome the hurdle of sparse and incomparable data and further broadly comparative research by developing latent variable measurement models of public opinion [see @Caughey2019; @Claassen2019; @Solt2020a].
One prominent study, @Claassen2020a took advantage of this approach to measure dynamic public democratic support for 135 countries for up to 29 years and to then assess its relationship to democratic change.

It found that mass support had a positive impact on democratic change, especially the endurance of democracy.

The analysis models he used do not account, though, for measurement uncertainty.
The latent constructs are inherently accompanied by a quantity  of measurement uncertainty due to the unobservability of variables.
...
This paper reexamined the classic claim about public democratic attitude and democratic changes thoroughly through both sophisticated methods and bigger data.
In addition to incorporating uncertainty, we employed a more sophisticated measurement, the Dynamic Comparative Public Opinion (DCPO) model developed by @Solt2020a, to estimate democratic support for a larger dataset with 144 countries for up to 33 years between 1988 and 2020.
Surprisingly, our study revealed that the significant relationship between public support and democratic change disappeared once uncertainty was included in the replication analysis of @Claassen2020a model with his original data and the DCPO analysis with more data.
To be cautious, we then also reexamined @Claassen2020b analyses by following the same operations. 
Again, when uncertainty was incorporated, the significant relationship between democratic changes and public democratic attitude disappeared.   

The disappearing relationship might be caused by theoretical, methodological reasons, or both.

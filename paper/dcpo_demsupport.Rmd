...
Especially when measurement error is correlated with the dependent variable, the resulting bias could either attentuate or exaggerate the magnitude of the estimated effects [see, e.g., @Blackwell2017, p.360; @caughey_policy_2018, p.254].
...
Our approach of incorporating uncertainty is analogous to @Blackwell2017a's multiple overimputation, that is, creating multiple data set from the posterior distribution of the true latent value, applying analysis model for each dataset, and then averaging results by correcting both within and between imputation variance.
We also employ one alternative technique known as “method of composition” [@treier_democracy_2008, 215) as robuestness check [see Supplementary Appendix xx].

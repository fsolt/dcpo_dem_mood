...
Further, the survey data available across countries and over time on support for democracy--or indeed most topics in public opinion---are sparse and incomparable, greatly hindering the broadly comparative research needed to reach sound conclusions.
Recently, a few pioneering studies have sought to overcome the hurdle of sparse and incomparable data and advance broadly comparative research by developing latent variable measurement models of public opinion [see @Caughey2019; @Claassen2019; @Solt2020a].
A pair of prominent recent works took advantage of this latent variable approach to measure dynamic public democratic support for 135 countries for up to 29 years and to then assess its consequences for democratic change.
It concluded that mass support had a positive impact on democratic change, especially the endurance of democracy.

The models employed in this study's analyses, though, do not account for measurement uncertainty.
...
This paper reexamines the classic claim about public democratic attitude and democratic changes thoroughly through both sophisticated methods and bigger data.

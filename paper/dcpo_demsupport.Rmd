...
One classic but disputable question in comparative politics is the relationship between mass democratic support and countries' level of democracy.
A long-standing and widely accepted theory is that the level of mass democratic support determines the stability of a democratic system [e.g., @lipset_social_1959; @easton1965systems; @norris_democratic_2011], but empirical findings remain inconclusive [@inglehart_modernization_2005; @fails_changing_2010; @qi_how_2011; for a review of this literature, see @Claassen2020a].

One reason for the mixed results is the difficulties in measuring comparative public democratic support.
Public support for democracy is a latent variable, and the incorrect measurement of it may limit inferences about relationship between public opinion and democratic institutional development.
However, the sparsity and incomparability of public opinion data across countries over time have always been perplexing comparative studies for a long time [@Solt2020a].
Recently, a few pioneering studies have contributed to comparative public opinion studies using advanced latent variable measurement [@Caughey2019; @Claassen2019; @Solt2020a]. 

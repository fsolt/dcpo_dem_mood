...
We conduct inferences from the distributive data via a technique known as "method of composition" (MOC) [@Treier2008, p. 215].
...
Since measurement uncertainty associated with these latent variables can propogate into the inferences over coefficient parameters in models, we incorporate uncertainty by employing "Method of Composition" [@Tanner1996,p52], which has been applied in analyses with latent variables [@Trei2008;@Caughey2018;@K2015].

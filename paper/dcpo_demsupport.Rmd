...
First, while the @Claassen2019 model dichotomizes responses and so discards some information provided by the 50 ordinal survey items (of 52 total) employed in Claassen [-@Claassen2020a; -@Claassen2020b], the DCPO model makes use of all of the information available from these ordinal items [@Solt2020a, p.5].
...
Even with the advantages of the DCPO model, there is no evidence to support the conclusions of Claassen [-@Claassen2020a; -@Claassen2020b] that public support sustains democratic regimes or that public support responds thermostatically to changes in democracy.

...
This allows MOC to be broadly applicable to many different types of models, including time-series-cross-sectional models [@CaugheyWarshaw2018a, A15-16], Cox proportional hazards models [@TreierJackman2008, 215], or models of individual-level roll call voting [@KastellecEtAl2015, 791].^[For additional details on the MOC technique, see  OSM \@ref(moc).]

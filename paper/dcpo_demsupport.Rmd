...
claassen_replication <- read_csv(here::here("data", "claassen_replication.csv"),
                   col_types = "cdcddcdc") %>% 
  janitor::clean_names() %>% 
  DCPOtools::with_min_yrs(2)
...
# (APPENDIX) Appendix {-}
# Numeric Results for Replicating @Claassen2020a
...
# Numeric Results for Replicating @Claassen2020b

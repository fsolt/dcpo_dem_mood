...
The technique and codes used in this study can be handily applied to empirical studies with latent variables and address the uncertainty for models with only one or multiple latent variables in both sides of the models without any further requirements for models. 

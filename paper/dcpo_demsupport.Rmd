...
output: 
  pdf_document:
    ...
    template: https://raw.githubusercontent.com/junkpolisci/website/master/working_content/svm-latex-ms2.tex
...
p_load(
  ...
  DCPOtools, # analysis
  huxtable, kableExtra, # tabulation
  latex2exp, # visualization
  purrr, broom, tidyverse
...
supdem <- get_file("Support for democracy.tab", "doi:10.7910/DVN/A47LUM") %>% 
  read_csv

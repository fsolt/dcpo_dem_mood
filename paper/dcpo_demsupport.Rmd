...
Recent cross-national time-series measures of, for example, European policy ideology [developed in @Caughey2019], immigration mood and immigration concern [presented in @Claassen2022], and public gender egalitarianism [introduced in @Woo2022], make possible a host of previously infeasible analyses, but the resulting research cannot be considered robust if it does not also incorporate these measures' quantified uncertainty.

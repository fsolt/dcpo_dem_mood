...
index_coefName <- c(
    ...
    `diff(Liberal_z, lag = 1)` = "Delta~Support(electoral)",
    `diff(Vdem_liberal_z, lag = 1)` = "Delta~Support(electoral)",
    `plm::lag(Liberal_z, 1)` = "Support[t-1](electoral)",
    `plm::lag(Vdem_liberal_z, 1)` = "Support[t-1](electoral)",
    `diff(Polyarchy_z, lag = 1)` = "Delta~Support(minoritarian)",
    `diff(Vdem_polyarchy_z, lag = 1)` = "Delta~Support(minoritarian)",
    `plm::lag(Polyarchy_z, 1)` = "Support[t-1](minoritarian)",
    `plm::lag(Vdem_polyarchy_z, 1)` = "Support[t-1](minoritarian)",

...
```{r claassenUncertaintyAJPS,eval=FALSE}
...
plot_AJPS1 <- dwplot(df_plotS, dodge_size = 0.8) +
  scale_color_uiowa(name = "", palette = "digitMixed") +
  labs(
    title = "DV: Institutional Democracy (Vdem)",
    subtitle = "Pooled"
  ) +
...
plot_AJPS2 <- dwplot(df_plotS, dodge_size = 0.8) +
  scale_color_uiowa(name = "", palette = "digitMixed") +
  labs(
    title = "",
...
```{r visualizedUncertainAJPS, fig.cap= "The Effect of Democratic Mood on Institutional Democratization Accounting for Uncertainty", eval=FALSE}
...
plot_APSR1 <- dwplot(df_plotS, dodge_size = 0.8) +
  scale_color_uiowa(name = "", palette = "digitMixed") +
  labs(
...
plot_APSR2 <- dwplot(df_plotS, dodge_size = 0.8) +
  scale_color_uiowa(name = "", palette = "digitMixed") +
  labs(
    title = "",
...
```{r visualizedUncertaintyAPSR, fig.cap= "The Effect of Democratic Mood on Institutional Democratization based on DCPO", eval = FALSE}

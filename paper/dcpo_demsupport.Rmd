...
tidy_result_clsUncertain <- map(ls_mod, possibly(function(aMod){ # reading a model
  ...
  result_vars <- ifelse(class(result[[1]])[1] == "plm", 
                        mitools::MIextract(result, fun = vcovBK_se),
                        mitools::MIextract(result, fun = vcovHC_se))

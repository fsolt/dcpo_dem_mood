...
result_vars_dcpo_1k <- map(df_result_dcpoAPSR, function(aFit){
      mitools::MIextract(aFit, fun = vcovHC_se)
    })

result_betas_dcpo_1k <- map(df_result_dcpoAPSR, function(aFit){
      mitools::MIextract(aFit, fun = coef)
    })
    
  
df_result_dcpoAPSR <- map2(result_vars_dcpo_1k, result_betas_dcpo_1k, function(aVar, aBeta){
    summary(

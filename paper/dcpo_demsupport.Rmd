...
thanks: "The authors contributed equally to this work.  Corresponding author: [yuehu@mail.tsinghua.edu.cn](mailto:yuehu@mail.tsinghua.edu.cn).  Current version: August 20, 2021."

author: "Yuehong 'Cassandra' Tai^[University of Iowa], Yue Hu^[Tsinghua University], and Frederick Solt$^{\\dagger}$"
...
where $\theta$ is latent varibles with measurement errors conditional on data Z and a measurement model, $w$ is other predictors without errors, $Z$ is indicators for latent variables $\theta$, and $y$ is the outcome variable.
...
Figures A.1 and A.2 display these results as the righthand set of results, with the replication of the articles' original results based only on point estimates on the left and our extension with uncertainty and more data, but the articles' original, @Claassen2019, model in the middle for comparison.

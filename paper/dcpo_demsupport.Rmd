...
Although measurement uncertainty has not yet attracted attention in the field of comparative public opinion [see, in addition to the works examined here, @OGrady2019], latent variables are always estimated with a quantifiable amount of measurement error, and ignoring measurement error in analyses can attenuate, exaggerate, or even reverse coefficient estimates as well as bias standard errors [see, e.g., @Bound2001, 3709; @Blackwell2017, 318-319; @caughey2018, 254; @Saccenti2020, 8].
...
In analysis stage, uncertainty is incorporated through simulation based on the variance-covariance matrix of a given model, regardless of its structure or features.
This allows MOC to adapt to many different types of models, including but not limited to different time-series-cross-sectional specifications [@caughey2018, A15-16], Cox proportional hazards models [@Treier2008, 215], or models of individual-level roll call voting [@Kastellec2015, 791].^[For additional details on the MOC technique, see Supplementary Information Appendix \@ref(moc).]
...
Recent cross-national time-series measures of, for example, policy ideology in Europe [developed in @Caughey2019], immigration attitudes across Europe [presented in @Claassen2022], and public gender egalitarianism worldwide [introduced in @Woo2022], make possible a host of previously infeasible analyses, but the resulting research cannot be considered robust if it does not also incorporate these measures' quantified uncertainty.

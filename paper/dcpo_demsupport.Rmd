...
In analysis stage, uncertainty is incorporated through simulation based on variance-covariance matrix of a given model, regardless of the structures of the given model.
Therefore MOC can adapt any different types of models, including but not limited to different specifications for a Time-Series-Cross-Sectional approach [@caughey2018, A15-16], a Cox proportional hazards model [@Treier2008, 215], or individual level roll call voting model [@Kastellec2015, 791].^[For additional details on this technique, see Supplementary Information Appendix \@ref(moc).]

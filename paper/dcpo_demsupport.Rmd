...
In short, the conclusions of Claassen [-@Claassen2020a; -@Claassen2020b] that public support has a positive effect on democracy and change in democracy a negative effect on change in support are not empirically supported once measurement uncertainty is taken into account, even when more data are used.  These null results have a number of important substantive implications.
...
Whether these conditional relationships exist among the newly available latent-variable data on democracy and democratic support is a promising avenue for future research. 

Further, these null results suggest a careful reconsideration of the relationship between concept and measure for those seeking to construct latent-variable measures of democratic support.
The most concerning issue is that the survey items employed---which ask respondents to assess the desirability or appropriateness of democracy, to compare democracy to some undemocratic alternative, or to assess one of these alternatives---may not capture every aspect of democratic support necessary for it to play its hypothesized roles in the classic theory.
...
Yet another is that the answers to the above items reflect actual support for democracy only when respondents also hold a robust understanding of what democracy means: otherwise, positive responses indicate support for autocracy instead [see, e.g., @Brunkert2019, @Kirsch2019, @Wuttke2021].
...
Finally, by failing to provide evidence for a straightforward relationship between democratic support and democracy, these null findings lend additional support to rival understandings of regime change.
There are compelling arguments that democratic transitions [see, e.g., @ODonnell1986; @Karl1987] and backsliding [see, e.g., @levitsky_how_2018, @Haggard2021] are primarily a matter of elite decision making.
<!-- [But Norris critique] -->
...
Taking uncertainty into account rendered both articles' conclusions without empirical support, even when we added considerable additional data.
...
The null results reached in this letter have several implications.

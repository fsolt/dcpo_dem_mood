...
As demonstrated here, this can be done straightforwardly using the method of composition [see @Tanner1993, 52; @Treier2008, 215], without requiring any further change in modeling strategy. 

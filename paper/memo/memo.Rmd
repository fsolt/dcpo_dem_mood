...
Reviewer 4 raised the question of whether accounting for uncertainty should affect the point estimates at all, rather than simply inflating the standard errors (a concern perhaps also raised indirectly by Reviewers 1 and 2).

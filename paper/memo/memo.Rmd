...
First, we need to clarify that the DV in Figure2 is the _change_ of public support for democracy rather than current public support.
Second, when DV is the change of public support, Claassen's original results of lagged support do not make any sense. 
...
Claassen's results indicate that a high public support in 2020 leads to a bigger change in mood in 2021 but a high support in 2019 leads to a smaller change in mood in 2021.
...
In contrast, our null results of lagged support on change of support mood indicate that the change of moods might not be dependent on its previous situation but might be shaped by exogenous factors, especially a shock in democratic or economic environment.

In terms of the effects of social and economic environment on the change in mood, even in Claassen's original results (the uppermost results in Figure \@ref(fig:plot-mainAPSR)),  point estimates of the change in democracy,  economic growth, corruption index as well as their lagged level, are close to zero in magnitude. 
...
As @Treier2008 [p213] emphasized, accounting of uncertainty maintains the significant effect of democracy mainly in applications where democracy strongly affects the quantity of interest and models are simple enough.
Given the measurement errors in public support, democratic indices, and corruption index, it is not surprising to see the diminution of the estimated effects.

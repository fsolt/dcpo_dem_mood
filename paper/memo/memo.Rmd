...
The understand of democracy problem could be "misunderstanding" in both authoritarian countries and democratic countries. 
In democracies, the "misunderstanding" is related to another issue which should attract more theoretical discussion, that is, the choice between generic support for democracy and other values especially in the long built democracies [see @bartels_ethnic_2020; @Carey2020; @graham_democracy_2020; @McCoy2020].
The disparity between the public's generic support and their commitment to support lends light to the recent democracy crisis and the uprising of populism witnessed in well-developed democracies.

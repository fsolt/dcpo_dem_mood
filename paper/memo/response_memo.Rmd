...
We provide a full description of the MOC technique in Supplementary Information Appendix B.
...
We drop cites here to Blackwell, Honaker, and King [-@Blackwell2017, 318-319; -@Blackwell2017a, 360-361]---who present simulations that, while aimed at other issues, nonetheless illustrate the point neatly---as well as to @caughey2018 [254].
...
So we took the _other_ suggestion from R1 on this topic, hinted at by R2 as well, to simply drop DCPO from the text entirely and move the analyses with the DCPO estimates to Appendix C in the Supplementary Information.

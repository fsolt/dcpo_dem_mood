...
1. **Method: ~~Better Estimates of Public Support and~~ Adding More Data** R1 and R4 asked for more detail on the differences between the DCPO model and the latent variable model used by Claassen.
...
So we took the _other_ suggestion from R1 on this topic to simply drop DCPO from the text entirely and moved the analyses with the DCPO estimates to the Supplementary Information.
